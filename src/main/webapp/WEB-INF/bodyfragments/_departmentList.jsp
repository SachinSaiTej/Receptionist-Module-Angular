...
<c:url var="addUrl" value="/ctl/department" />

<c:url var="addSearch" value="/ctl/department/search" />

<c:url var="editUrl" value="/ctl/department?id=" />
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			...
			<a href="${pageContext.request.contextPath}/ctl/department"
						...
						<div class="card">
							...
							<div class="card-body">
								<table id="example2" class="table table-bordered table-hover">
									...
									<tbody>
										<c:forEach items="${list}" var="dep" varStatus="depart">
											<tr>
												<td><input type="checkbox" class="case" name="ids"
													value="${dep.id}"></td>
												<td>${depart.index+1}</td>
												<td><c:out value="${dep.name}" /></td>
												<td><c:out value="${dep.status}" /></td>
												<td><c:out value="${dep.description}" /></td>
												<td><a href="${editUrl} ${dep.id}"

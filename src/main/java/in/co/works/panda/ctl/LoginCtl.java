...
import in.co.works.panda.form.ChangePasswordForm;
import in.co.works.panda.form.ForgetPasswordForm;
import in.co.works.panda.form.LoginForm;
import in.co.works.panda.form.MyProfileForm;
import in.co.works.panda.form.UserRegistrationForm;
import in.co.works.panda.service.UserServiceInt;
...
public class LoginCtl extends BaseCtl {
	...
	public String display(@ModelAttribute("form") @Valid ForgetPasswordForm form,
		...
		UserDTO dto = service.findByUserName(form.getLogin());
